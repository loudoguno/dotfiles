...
# Close Sys Pref to prevent overridding changes
...
# Set computer name to Lou2010MBP(as done via System Preferences → Sharing)
sudo scutil --set ComputerName "Lou2010MBP"
sudo scutil --set HostName "Lou2010MBP"
sudo scutil --set LocalHostName "Lou2010MBP"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Lou2010MBP"
...
# Set sidebar icon size to small (1) - medium (2)
defaults write NSGlobalDomain NSTableViewDefaultSizeMode -int 
...
# Set trackpad speed to highest
sudo defaults write NSGlobalDomain com.apple.trackpad.scaling -int 3
